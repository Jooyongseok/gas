...
import { generateDummyOrders } from '@/lib/dummy-data';
...
export async function GET() {
  try {
    ...
    console.log('[BFF] trading/orders: 더미 데이터 사용 -', error instanceof Error ? error.message : 'unknown');
    return NextResponse.json(generateDummyOrders());
  }
}
